---
title: "Macau-201507-Prediction-Result"
author: "小新"
date: "2015年8月19日"
...
load("Macau-Prediction-result-2015-07-01.Rdata")

```


`r knitr::kable(benchmark[,c(3,8,9,10,11,12,13)],caption=paste("最终预测结果汇总表", as.Date(target.time),sep=""))`
